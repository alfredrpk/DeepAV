...
class DataLoader:
    def __init__(
        ...
        os.chdir('..')
        self.data_dirs = os.getcwd() + "/data/prediction_train/"
        ...
        data_file = os.path.join(os.getcwd() + "\\data\\", "trajectories_TP_pedestrians.cpkl")
        if infer == True:
            data_file = os.path.join(os.getcwd() + "\\data\\", "trajectories_TP_pedestrians_test.cpkl")
